...
* [Staging workspace registered model](https://adb-5567788032172930.10.azuredatabricks.net#mlflow/models/staging-my-mlops-project-model)
* [Prod workspace registered model](https://adb-5567788032172930.10.azuredatabricks.net#mlflow/models/prod-my-mlops-project-model)
